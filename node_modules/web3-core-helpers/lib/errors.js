...
module.exports = {
    ErrorResponse: function (result) {
        ...
        var err = new Error('[Node Error] Returned error: ' + message);
        err.data = data;
        return err;
    },
    ...
    InvalidResponse: function (result) {
        ...
        return new Error("[Node Error] " + message);
    },
    ...
    RevertInstructionError: function (reason, signature) {
        var error = new Error('[Node Error] Your request got reverted with the following reason string: ' + reason);
        error.reason = reason;
        error.signature = signature;
        return error;
    },
    TransactionRevertInstructionError: function (reason, signature, receipt) {
        var error = new Error('[Node Error] Transaction has been reverted by the EVM:\n' + JSON.stringify(receipt, null, 2));
        error.reason = reason;
        error.signature = signature;
    ...
    TransactionRevertedWithoutReasonError: function (receipt) {
        return this.TransactionError('[Node Error] Transaction has been reverted by the EVM:\n' + JSON.stringify(receipt, null, 2), receipt);
    },
    TransactionOutOfGasError: function (receipt) {
        return this.TransactionError('[Node Error] Transaction ran out of gas. Please provide more gas:\n' + JSON.stringify(receipt, null, 2), receipt);
    },
